...
function LibrarianBrowseBooks() {
  ...
  // AJAX-style real-time search for categories
  useEffect(() => {
  ...
  let gridColumns = "2fr 1.5fr 1fr 1.5fr";
  if (userRole === 'librarian') {
    gridColumns = "2fr 1.5fr 1fr 1fr 2.5fr";
  }
  ...
  return (
    <div>
      ...
      {!selectedCategory ? (
        <div className="librarian-category-page">
          <img src="/images/browse-books-bg.jpg" alt="Category" className="category-bg-image" />
          <div className="category-page-container">
            <div className="librarian-category-header">
              <h2 className="librarian-category-title">Browse Categories</h2>
              <input
                type="text"
...
export default LibrarianBrowseBooks;